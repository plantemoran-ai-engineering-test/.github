# Default (root) GitHub project (Test)
...
**NOTE:** Always be sure to use **_only_** approved versions from the [Developer Workstation
Configuration][developer-workstation-config-docs] guide.
...
This repo contains issue form templates:
...
This special repository also contains a special file `./profile/README.md` that will appear on
the organizations profile.
...
[developer-workstation-config-docs]:
  https://plantemoran-appdev.github.io/github-process-docs/workstation-setup/workstation-config/
[gh-action--lint]:
  https://github.com/plantemoran-ai-engineering-test/.github/actions/workflows/linting.yml
[gh-creating-default-comm-health-file]:
  https://help.github.com/en/github/building-a-strong-community/creating-a-default-community-health-file
[img--gh-action-badge--lint]:
  https://github.com/plantemoran-ai-engineering-test/.github/actions/workflows/linting.yml/badge.svg